...
export class MainLayout extends BlitElement 
{
    ...
    private get navClasses()
    {
        return this.menuVisible ? "invisible w-0 sm:visible sm:w-auto" : "";
    }
    ...
    render()
    {
        ...
        <div class="grid grid-cols-[min-content,auto] grid-rows-[min-content,auto] h-full @debug">
            ...
            <div class="${this.navClasses} pt-6 border-r-2 border-neutral-300 dark:border-neutral-600" >
                <nav-menu></nav-menu>
            </div>
    ...
    // private menuClasses(foo: Boolean)
    // {
    //     return classMap(
    //         {
    //             opacity: foo ? 1 : 0,
    //             'transition-duration': foo ? '700ms' : '50ms'
    //         });
    // }
